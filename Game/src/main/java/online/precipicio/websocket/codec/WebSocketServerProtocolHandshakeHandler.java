package online.precipicio.websocket.codec;
...
import static online.precipicio.websocket.WebSocketServerHandler.WS_SESSION_PARAMS;
...
class WebSocketServerProtocolHandshakeHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(final ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        ctx.channel().attr(WS_SESSION_PARAMS).set(params);
